...
var requestURL = "https://api.openweathermap.org/data/2.5/weather?q=`{}`&appid=82b88905657c227b366aeed2a3762dff"
...
// so I grabbed the weather form using jquery and saved it in citySearchName 
var citySearchName = $("#weather-form");
// then I grabbed the input and saved it in nameInputEl
var nameInputEl =$(".city-name")
//this mi ght be redundant because I have an onclick on the html
